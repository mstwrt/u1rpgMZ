 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version added easier processing of hotkeys in menu
 * scenes. This is something my command window plugins will be using soon, and
 * may also be used by some other plugins for key press monitoring as needed.
 *
 * It also added an option to the URL open utility function to try popup first.
 * Another utility function, for taking TTS JSON parameters and parsing them to
 * js objects, was also added. This will be used for integrations with the
 * upcoming [CGMZ] TTS plugin.
 *
 * Version 1.26.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.26.0";
CGMZ.Core = {};
